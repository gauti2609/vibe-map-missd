    ...
    return (
        <div className="relative h-[calc(100vh-80px)] md:h-screen w-full overflow-hidden flex items-center justify-center p-4">
            ...
            {onBack && (
                <button
                    onClick={onBack}
                    className="absolute top-6 right-6 z-50 bg-slate-950/80 backdrop-blur-md p-3 rounded-full text-white border border-white/20 hover:bg-white/20 transition shadow-2xl"
                >
                    <X className="w-6 h-6" />
                </button>
            )}
                    ...
                    <div className="space-y-4 mb-6 relative">
                        <div className="pl-4 border-l-4 border-purple-500">
                            <p className="text-lg font-medium text-slate-200 italic leading-relaxed">
                                "The night it all clicked. Vibes locked, moments made, memories lived. This is just the beginning—next drop incoming. 🔥🚀"
                            </p>
                        </div>
                    </div>
